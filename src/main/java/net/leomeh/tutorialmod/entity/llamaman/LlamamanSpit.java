...
public class LlamamanSpit extends Projectile {
    public LlamamanSpit(EntityType<? extends net.minecraft.world.entity.projectile.LlamaSpit> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public LlamamanSpit(Level pLevel, LlamamanEntity pSpitter) {
